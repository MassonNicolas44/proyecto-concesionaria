...
<?php $rols=['Gerente','Ventas'];?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="postalCode" type="number" class="form-control @error('postalCode') is-invalid @enderror" name="postalCode" value="{{ $user->postalCode }}" required autocomplete="postalCode">
