                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="loginCode" type="loginCode" class="form-control @error('loginCode') is-invalid @enderror" name="loginCode" value="{{ old('loginCode') }}" required autocomplete="loginCode" autofocus>
